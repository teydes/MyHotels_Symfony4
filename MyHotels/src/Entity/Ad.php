...
class Ad
{
     ...
     * @Assert\Length(min="10", max="255", minMessage="Le titre doit faire au moins 10 cartactères !", maxMessage="Le titre ne peut faire plus de 255 caractères")
     */
    private $title;
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min="100", minMessage="Votre description ne peut faire moins de 100 caractères")
     */
    private $content;
